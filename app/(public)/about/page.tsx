...
export const metadata: Metadata = {
  title: 'About | Overwatch Coaching',
  description: 'Learn about your coach - experience, achievements, and coaching philosophy. Helping players improve since 2016.',
};
      ...
      <section className="py-20 bg-gradient-to-b from-[#0f0f23] to-[#1a1a2e]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Let's work together to take your Overwatch skills to the next level. Book a session or reach out with any questions.
            </p>
