        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              {/* Contact Form */}
              <div>
                <h2 className="text-3xl font-bold text-text-primary mb-6">{locale.form?.section_title}</h2>
              ...
              {/* Contact Information */}
              <div>
                <h2 className="text-3xl font-bold text-text-primary mb-6">{locale.contact_info?.section_title}</h2>
                ...
                <div className="space-y-6">
                  ...
                  <Card variant="surface" padding="lg">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-bold text-text-primary text-lg mb-2">{locale.contact_info?.discord?.title}</h3>
                        <p className="text-text-muted">
                  ...
                  <Card variant="surface" padding="lg">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-bold text-text-primary text-lg mb-2">{locale.contact_info?.response_time?.title}</h3>
                        <p className="text-text-muted">
