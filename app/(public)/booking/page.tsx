...
function BookingContent() {
  ...
  const getCoachingTypeDescription = () => {
    switch (selectedType) {
      case 'review-async':
        return 'I review your replays when I have the chance and send you structured notes focusing on 1-2 key patterns to work on. Most accessible option.';
      case 'vod-review':
        return 'I review the code beforehand, then we go through it together. I\'ll pause at key points and ask what you were thinking - teaching you how to think, not just what to do.';
      case 'live-coaching':
        return 'Submit replays so I can understand your playstyle first. Then in our live session, I\'ll sit over your shoulder while you play and help break stubborn habits in real-time.';
      default:
        return '';
    }
  };
  ...
  const getTurnaroundMessage = () => {
    switch (selectedType) {
      case 'review-async':
        return 'I\'ll review when I have time and send you notes - no rush, no pressure';
      case 'vod-review':
        return 'Select an appointment time that works for you';
      case 'live-coaching':
        return 'Select an appointment time that works for you';
      default:
        return '';
