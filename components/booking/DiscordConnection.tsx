      ...
      <Card variant="surface">
        <CardContent className="py-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-400">Checking Discord connection...</span>
          </div>
        </CardContent>
      </Card>
    );
        ...
        <CardContent className="py-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-200">Discord Connected</p>
                <p className="text-xs text-gray-400">
                  {status.username}
                  {status.expired && <span className="text-yellow-400 ml-2">(Session expired)</span>}
                </p>
              </div>
            </div>
            <Button
          ...
          {status.expired && (
            <div className="mt-3 p-3 bg-yellow-600/10 border border-yellow-600/30 rounded-lg">
              <p className="text-xs text-yellow-400">
                Your Discord session has expired. Reconnect to continue receiving notifications.
              </p>
            </div>
          )}
