    ...
    return (
      <Card variant="surface" className="border-green-600/30">
        <CardContent className="py-4">
          ...
          <div className="mt-3 p-3 bg-brand-600/10 border border-brand-600/30 rounded-lg">
    ...
    <Card variant="surface">
      <CardContent className="py-4">
        <div className="flex items-start gap-3 mb-4">
          <div className="flex items-center justify-center w-10 h-10 bg-brand-600/20 rounded-lg flex-shrink-0">
        ...
        <div className="p-3 mt-3 bg-brand-600/10 border border-brand-600/30 rounded-lg">
          <p className="text-xs text-brand-300">
