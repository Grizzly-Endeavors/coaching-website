  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10">
        <button
          onClick={() => paginate(-1)}
          className="p-2 rounded-full bg-background-elevated border border-purple-primary/30 text-purple-primary hover:bg-purple-primary hover:text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-cyan-primary"
      ...
      <div className="relative overflow-hidden min-h-[350px] md:min-h-[300px]">
        <AnimatePresence initial={false} custom={direction}>
          ...
          >
             <Card variant="surface" className="w-full max-w-3xl bg-background-elevated/50 backdrop-blur-sm border-purple-primary/20 h-full">
              <CardContent className="p-8 md:p-12 flex flex-col items-center text-center h-full justify-center">
                <Quote className="text-purple-primary w-12 h-12 mb-6 opacity-50" />
                ...
                <div className="mt-auto">
                  ...
                  <div className="text-text-muted text-sm mt-1 flex items-center justify-center gap-2">
                    <span className="px-2 py-0.5 rounded-full bg-purple-primary/20 text-purple-200 text-xs border border-purple-primary/30">
        ...
        {items.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all duration-300 ${
              index === currentIndex
                ? 'bg-cyan-primary w-6'
                : 'bg-purple-primary/30 hover:bg-purple-primary/60'
            }`}
