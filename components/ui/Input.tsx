...
export const Input: React.FC<InputProps> = ({
  ...
  const baseClasses = `w-full px-4 py-2.5 bg-[#1a1a1a] border rounded-lg text-gray-200 placeholder-gray-500 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed ${
    error
      ? 'border-red-500 focus:ring-red-500'
      : 'border-[#2e2e2e] hover:border-cyan-600/50'
  }`;
