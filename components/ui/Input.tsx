...
export const Input: React.FC<InputProps> = ({
  ...
  const baseClasses = `w-full px-4 py-2.5 bg-background-surface border rounded-lg text-gray-200 placeholder-gray-500 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed ${
    error
