...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({
      ...
      <div className="relative">
        ...
        {variant === 'primary' && (
          <div className="absolute inset-0 animate-pulse">
            <div className="absolute inset-0 rounded-full blur-lg bg-purple-600/30" />
          </div>
        )}
      </div>
  ...
  if (fullScreen) {
    return (
      <div
        className="fixed inset-0 z-50 flex items-center justify-center bg-[#0f0f23]/90 backdrop-blur-sm"
        role="alert"
        aria-live="polite"
        aria-busy="true"
      >
...
export const LoadingOverlay: React.FC<{ isLoading: boolean; text?: string }> = ({ isLoading, text }) => {
